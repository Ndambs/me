...
(function () {
  ...
  function renderDay(id) {
    ...
    var voiceHtml = "";
    if (d.voice_text) {
      voiceHtml = '<div class="bs-voice-card"><span class="quote-mark">&ldquo;</span><p>' +
        escapeHtml(d.voice_text) + '</p><div class="attrib">' + "\u2014 " + escapeHtml(titleCase(d.voice_name)) + "</div></div>";
    }
